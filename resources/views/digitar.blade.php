...
<body>
    <div class="titulo_boton">
        REGISTRAR USUARIO
        <button type="button" class="btn btn-primary" onClick="muestra_oculta('contenido')">Mostrar</button>
        {{-- <a style='cursor: pointer;' onClick="muestra_oculta('contenido')" title="" class="btn-primary">Mostrar / Ocultar</a> --}}
    </div>
    <div class="titulo_boton">
        SOROLOGIA
